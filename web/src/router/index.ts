...
import InsightsPage from "../features/insights/InsightsPage.vue";`r`nimport MyPage from "../features/mypage/MyPage.vue";
...
export const router = createRouter({
  ...
  routes: [
    ...
    { path: "/insights", name: "insights", component: InsightsPage },`r`n    { path: "/mypage", name: "mypage", component: MyPage },
